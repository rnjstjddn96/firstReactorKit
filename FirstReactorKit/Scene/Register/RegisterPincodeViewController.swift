...
class RegisterPincodeViewController: BaseViewController<RegisterPincodeReactor> {
...
extension RegisterPincodeViewController: View {
...
class RegisterPincodeReactor: Reactor {
