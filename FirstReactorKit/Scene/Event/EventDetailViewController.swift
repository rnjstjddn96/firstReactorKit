...
//  FirstReactorKit
//
//  Created by imform-mm-2103 on 2021/08/09.
//
...
class DetailView: UIViewController, UIScrollViewDelegate {
    ...
    private let cardViewModel: EventData
    private(set) var cardView: CardView?
    
    init(cardViewModel: EventData) {
...
extension DetailView {
    ...
    func configureCardView() {
        ...
        cardViewModel.viewMode = .full_CardViewMode
        cardView = CardView(eventData: cardModel)
